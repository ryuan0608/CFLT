...
//===========================================================================
void CCNF_patch_expert::Response(const cv::Mat_<float> &area_of_interest, cv::Mat &response)
{
...
void CCNF_patch_expert::ResponseOpenBlas(const cv::Mat &area_of_interest, cv::Mat &response, cv::Mat_<float>& im2col_prealloc)
{
